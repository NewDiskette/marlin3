...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link ">
        <?php 
        $description1 = 'Your privacy is important to us at SmartAdmin and the protection, confidentiality and integrity of your personal data are our prime concerns.
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <?php foreach($contents as $content):?>
                                ...
                                <p class="mb-g"><?php echo $content['description'];?></p>
                            <?php endforeach;?>
